                ...
                <div class="card shadow-lg mb-3 border-0" style="border-radius: 8px;">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('login.post') }}" method="POST">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="password" name="password" class="form-control" placeholder="Account Password" value="password" required>
                                <div class="form-control-feedback">
                            ...
                            <div class="form-group d-flex align-items-center justify-content-between mb-3">
                                ...
                                <span class="font-size-xs text-muted">SSL Encrypted</span>
                            </div>
