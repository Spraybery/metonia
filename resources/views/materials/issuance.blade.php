...
<div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap" style="gap: 12px;">
        ...
        <div>
            ...
            <button type="button" class="btn btn-danger font-weight-semibold shadow-xs" data-toggle="modal" data-target="#modal-issue-vehicle">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <label class="font-weight-semibold mb-0">Material Description <span class="text-danger">*</span></label>
                            @if(Auth::user()->canEdit('materials'))
