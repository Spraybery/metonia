...
<div class="content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap" style="gap: 12px;">
        ...
        <div>
            <a href="{{ route('materials.restock_needed.print', ['type' => 'materials']) }}" target="_blank" class="btn btn-outline-warning text-dark font-weight-semibold shadow-xs mr-1">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 form-group">
                            ...
                            <select name="category" class="form-control" required>
                                @foreach($categories as $cat)
                                    @if($cat !== 'Worker Safety & PPE' && $cat !== 'Reflecting & Safety')
