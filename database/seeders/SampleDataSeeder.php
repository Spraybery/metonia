...
class SampleDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        VehicleStageHistory::create([
            'vehicle_id' => $v1->id,
            'stage' => '2. Structural & Frame',
            'transitioned_at' => Carbon::now()->subDays(14),
        ]);
        ...
        VehicleStageHistory::create([
            'vehicle_id' => $v2->id,
            'stage' => '3. Powertrain & Mechanical',
            'transitioned_at' => Carbon::now()->subDays(11),
        ]);
        ...
        // 4. Seed Tools & Equipment Register
        $tools = [
            [
            ...
            [
                ...
                'status' => 'Checked Out',
                'assigned_to' => 'Eng. John Otieno',
                'next_calibration' => Carbon::now()->subDays(5),
            ],
            [
            ...
            [
                ...
                'next_calibration' => Carbon::now()->addDays(8),
            ],
            [
            ...
            [
                ...
                'status' => 'Available',
                'assigned_to' => 'In Tool Crib',
                'next_calibration' => Carbon::now()->subDays(12),
            ],
        ];
